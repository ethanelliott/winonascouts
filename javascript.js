...
function startTime() {var today=new Date();var h=today.getHours();var m=today.getMinutes();var s=today.getSeconds();m=checkTime(m);s=checkTime(s);document.getElementById('time').innerHTML=h+":"+m+":"+s;t=setTimeout(function(){startTime()},500);}
function checkTime(i){if (i<10){i="0" + i;}return i;}
function getTheTime() {var today=new Date();var h=today.getHours();var m=today.getMinutes();var s=today.getSeconds();m=checkTime(m);s=checkTime(s);xtimex = h+":"+m+":"+s;return xtimex;}

//Mobile Correction stuff
function mobileMenu() {
	switch (mobileState)
	{
		case 0:	//If the menu is closed
				document.getElementById('mobile-menu').style.height="355px";
				mobileState = 1;
				break;
		case 1:	//If the menu is open
				document.getElementById('mobile-menu').style.height="50px";
				mobileState = 0;
				break;
	}
};
        ...
        for (d = n = 0; d < b.length; d++) {
            ...
            if (this.bq[k].use) {
                ...
                if (this.T == "flip") {
                    ...
                    y: 0,
                    w: m,
                    h: g * 0, //HEIGHT OF LINE ACROSS TEXT
                    fill: "#000000"
